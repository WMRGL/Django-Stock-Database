...
urlpatterns = [
    ...
    re_path(r"^insertdates/(.*)/(.*)/$", views.insertdates, name="insertdates"),
    re_path(r"^valdates/$", views.valdates, name="valdates"),
    re_path(r"^compsearch/$", views.compsearch, name="compsearch"),
