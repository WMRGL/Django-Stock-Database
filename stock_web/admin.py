...
class Solution_Admin(admin.ModelAdmin):
    ...
    search_fields = (
        "recipe__name",
        "inventory__internal__batch_number",
        "creator_user__username",
        "comp1__reagent__name",
        "comp2__reagent__name",
        "comp3__reagent__name",
        "comp4__reagent__name",
        "comp5__reagent__name",
        "comp6__reagent__name",
        "comp7__reagent__name",
        "comp8__reagent__name",
        "comp9__reagent__name",
...
class PWResetForm(AdminPasswordChangeForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields["password1"] = forms.CharField(
            initial="stockdb1", widget=forms.HiddenInput(), label=""
        )
...
class UserCreationFormExtended(UserCreationForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields["password1"] = forms.CharField(
            widget=forms.HiddenInput(), initial="stockdb1"
        )
        self.fields["password2"] = forms.CharField(
            widget=forms.HiddenInput(), initial="stockdb1"
        )
